                                    ...
                                    <div class="bottom-post flex-shrink-0 pt-3"
                                        ...
                                        <form action="{{ route('comments.store', $post->id) }}" method="POST"
                                            ...
                                            <input type="text" id="comment-input-modal-{{ $post->id }}"
                                                ...
                                                style="width: 100%; font-size: 25px; border: 0;">
                                            <button type="submit">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="container d-flex flex-column"
                                    ...
                                    <div class="flex-grow-1 overflow-auto" style="min-height: 0;">
                                        <!-- Header Post -->
                                        <div
                                            class="d-flex justify-content-between align-items-center pe-3 flex-shrink-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ Storage::url($post->user->avatar ?? 'default-image.jpg') }}"
                                                    alt="Avatar"
                                                    style="object-fit: cover; width: 62px; height: 62px;"
                                                    class="rounded-circle me-2">
                                                <p style="font-size: 35px">
                                                    <a href="{{ route('user.show', $post->user->username) }}"
                                                        class="text-decoration-none text-dark">{{ $post->user->username }}</a>
                                    ...
                                    <!-- Fixed Bottom Section -->
                                    <div class="bottom-post flex-shrink-0 py-3"
                                        style="border-top: 1px solid #dee2e6;">
                                        <!-- Comment Form -->
                                        <form action="{{ route('comments.store', $post->id) }}" method="POST"
                                            class="d-flex">
